[![build](https://github.com/opspec-pkgs/aws.s3.cp-file-to/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/aws.s3.cp-file-to/actions/workflows/build.yml)
